...
export default function SaathiWorkflow() {
  ...
  if (screen === 'metrics') return <Layout><Header copy={copy} title={copy.whosWhoMetrics} eyebrow={copy.dashboardTitle} onBack={goBack} /><WhosWhoMetrics patientId={patientId} locale={language.dateFormatter} /></Layout>;
