...
export const emptySnapshot = (): LocalSnapshot => ({ items: [], sessions: [], events: [], outcomes: [], controllerStates: [], controllerStateChanges: [], settings: {}, skillTransmissionItems: [], activitySessions: [], activityEvents: [], skillCompletions: [] });
