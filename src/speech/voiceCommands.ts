...
const commands: Partial<Record<SpeechLanguageCode, SpeechCommand[]>> = {
  en: [
    ...
    { intent: 'start_whos_who', phrases: ["who's who", 'who is who', "open who's who", "play who's who", "start who's who"] },
    { intent: 'start_recipe', phrases: ['recipe', 'open recipe', 'play recipe', 'start recipe'] },
    { intent: 'start_days_plan', phrases: ["day's plan", 'days plan', 'daily plan', "open day's plan", 'open daily plan', "start day's plan"] },
  ...
  hi: [
    ...
    { intent: 'start_recipe', phrases: ['रेसिपी', 'recipe खोलें', 'recipe शुरू करें', 'रेसिपी खोलो'] },
  ...
  as: [
    { intent: 'go_home', phrases: ['পিছলৈ যাওক', 'ঘৰলৈ যাওক'] },
